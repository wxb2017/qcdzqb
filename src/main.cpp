...
int64 nChainStartTime = 1502350815;
...
const string strMessageMagic = "changecoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in changecoin
    bool fStrictPayToScriptHash = true; // Always active in changecoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "changecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector changecoin empty mapBlockIndex changecoin changecoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 298060 : 279540;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x05d5e4f113a826c7395da97ba3218c914c0fbec583b66344c6863793067ee01b"));
...
unsigned char pchMessageStart[4] = { 0x80, 0x61, 0x41, 0x80 };
